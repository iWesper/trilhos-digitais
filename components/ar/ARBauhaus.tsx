  ...
  return (
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <group name="Armature004" position={[6.275, 0.173, 59.013]} rotation={[Math.PI, 0, Math.PI]}>
        ...
        <skinnedMesh name="Cube001" geometry={(nodes.Cube001 as Mesh).geometry} material={materials.PaletteMaterial001} skeleton={(nodes.Cube001 as any).skeleton} position={[-33.686, 0.173, 34.246]} rotation={[0, Math.PI / 2, 0]} />
        <skinnedMesh name="Cube002" geometry={(nodes.Cube002 as Mesh).geometry} material={materials.PaletteMaterial001} skeleton={(nodes.Cube002 as any).skeleton} position={[-27.67, 0.173, 41.248]} rotation={[0, Math.PI / 2, 0]} />
        <skinnedMesh name="Cube003" geometry={(nodes.Cube003 as Mesh).geometry} material={materials.PaletteMaterial001} skeleton={(nodes.Cube003 as any).skeleton} position={[2.372, 0.727, 66.345]} rotation={[-Math.PI, 0, -Math.PI]} />
        <skinnedMesh name="Cube004" geometry={(nodes.Cube004 as Mesh).geometry} material={materials.PaletteMaterial001} skeleton={(nodes.Cube004 as any).skeleton} position={[6.275, 0.173, 59.013]} rotation={[-Math.PI, 0, -Math.PI]} />
      </group>
    </group>
    </Interactive>
  );
