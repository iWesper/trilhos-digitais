      ...
      <div className="bg-chapter3BG h-screen bg-origin-border bg-center bg-no-repeat bg-cover grid grid-cols-12 justify-center items-center p-4">
        ...
        >
          <Image
            ...
            draggable={false}
          />
          <div className="absolute text-white -bottom-6 2xl:-bottom-10 text-center w-full">Filme</div>
        </motion.div>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <Image
            ...
            draggable={false}
          />
          <div className="absolute text-white -bottom-6 2xl:-bottom-10 left-6 text-center w-full">Jogo</div>
        </motion.div>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <Image
            ...
            draggable={false}
          />
          <div className="absolute text-white -bottom-6 2xl:-bottom-10 left-12 text-end w-full">
            Banda Desenhada
          </div>
        </motion.div>
        <div className="col-span-3"></div>
