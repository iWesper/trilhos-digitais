...
export default function Chapter1Page7() {
    ...
    const [content, setContent]= useState<string | null>("No entanto, uma obra completa envolve interação com elementos e não apenas a visualização de acontecimentos, e é nesse aspeto que a multimédia entra.");
  ...
  return (
      UserId ? (
        ...
        <div className="bg-chapter1BG h-screen w-screen bg-origin-border bg-center bg-no-repeat bg-cover grid">
            <Link href="/chapters/chapter1/6" className="text-black absolute top-20 left-15 flex items-center cursor-pointer" >
