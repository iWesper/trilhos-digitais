    ...
    return (
        UserId ? (
          ...
          <div className="bg-chapter1BG h-screen w-screen bg-origin-border bg-center bg-no-repeat bg-cover grid grid-cols-2">
              <Link href="/chapters/chapter1/5" className="text-black absolute top-20 left-15 flex items-center cursor-pointer" >
                      <IoChevronBack className=" h-8 w-8" />
                      <span>Voltar</span>
              </Link>
              <div className="flex flex-col justify-center items-center p-10 mt-20 ">
                  <p className="font-medium mb-10">O cinema é considerado a 7ª Arte, e a evolução do conceito de <span className="italic">Wagner</span>, pois utiliza a síntese de várias artes que o precedem como da arquitetura, da escultura, da música ou da dança, para criar uma experiência única e emotiva que permite o espectador reviver momentos, reais ou fictícios.</p>
                  <Link href="/chapters/chapter1/7"><Button>Continuar</Button></Link>
              </div>
